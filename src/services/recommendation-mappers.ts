...
type ArtistsRelDoc =
  components['schemas']['Artists_Multi_Relationship_Data_Document'];
type TracksRelDoc =
  components['schemas']['Tracks_Multi_Relationship_Data_Document'];
type AlbumsRelDoc =
  components['schemas']['Albums_Multi_Relationship_Data_Document'];
...
export function mapSimilarArtistsResponse(
  doc: ArtistsRelDoc,
...
export function mapSimilarTracksResponse(
  doc: TracksRelDoc,
): SimilarTracksResult {
  const included = doc.included ?? [];
...
export function mapSimilarAlbumsResponse(
  doc: AlbumsRelDoc,
): SimilarAlbumsResult {
  const included = doc.included ?? [];
  const index = createIncludedIndex(included);
